...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:digas_fe_management/Resources/Private/Language/locallang_db.xlf:tx_digasfemanagement_domain_model_search',
        'label' => 'title',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_digasfemanagement_domain_model_search}.{#pid}=###CURRENT_PID### AND {#tx_digasfemanagement_domain_model_search}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
